	...
	<body>
		...
		<div class="container">
			...
			<header class="jumbotron my-4">
				<center>
					<h1 class="display-3">Oops, internal error</h1>
				</center>
				<br><br><br>
				<center>
					<p class="lead">We have a problem here and the error has been logged. </p>
				</center>
				<center>
					<p class="lead">If this keeps coming up, please report to <a href="mailto:admin@fmning.com">admin@fmning.com</a></p>
				</center>
				<br>
