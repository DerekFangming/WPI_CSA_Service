/* Note that this helper has dependency on common.js and popup.jsp for function showErrorPopup... Is this even a right thing?*/
(function ( $ ) {
    $.fn.imagePicker = function( options ) {
        ...
        return this.each(function() {
        		if (settings.src == '') {
        			...
        			//Fix for multiple pickers
        			$(this).html(create_preview(this, settings.src, settings));
        		}
    ...
    function create_btn(that, settings) {
        ...
        var picker_btn_input = $('<input type="file" class="' + settings.container + '" accept="image/jpeg, image/jpg, image/png" />');
